...
export default function ProductsByCat({getRandomOriginalPriceOfThreeDigits}) {
  ...
  async function getProductsByCat() {
    let res = await axios.get("https://fakestoreapi.com/products/category/" + navItem);
...
>
  ...
  let filteredProducts = productsByCat.filter((product) => product.category === navItem);
